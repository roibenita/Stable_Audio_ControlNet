...
csv_file_path = f'/home/rbenita/Projects/stable-audio-tools-synchformer-cond/Subjective_Evaluation/metadata_files/{data_set_type}.csv'
output_prompts_file = f'/home/rbenita/Projects/stable-audio-tools-synchformer-cond/Subjective_Evaluation/metadata_json/AudioCaps_Metadata_dict_{data_set_type}_synchformer.json'
root_directory = f'/home/rbenita/Projects/stable-audio-tools-synchformer-cond/Subjective_Evaluation/{data_set_type}/short_audio_files/all_files'
clip_embed_directory = f'/home/rbenita/Projects/stable-audio-tools-synchformer-cond/Subjective_Evaluation/{data_set_type}/synchformer_npy_padded_1_216_768/all_files'
output_file_path = f"/home/rbenita/Projects/stable-audio-tools-synchformer-cond/Subjective_Evaluation/pkl_files/dict_clip_AudioCaps_Synchformer_subjective_eval_{data_set_type}.pkl"
