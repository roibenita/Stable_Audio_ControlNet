...
from ..models.diffusion import DiffusionModelWrapper, ConditionedDiffusionModelWrapper, ControledConditionedDiffusionModelWrapper
...
class ControlDiffusionCondDemoCallback(pl.Callback):
    def __init__(self, 
                 demo_every=2000,
                 num_demos=8,
                 sample_size=65536,
